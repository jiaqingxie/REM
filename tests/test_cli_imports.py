...
class CliImportTests(unittest.TestCase):
    def test_rem_experiment_modules_import_without_optional_runtime_work(self):
        modules = [
            ...
            "experiments.cifar10.diagnose_descent_margin",
            "experiments.cifar10.diagnose_image_mobility",
            ...
            "experiments.synthetic.aggregate_inductive_bias_comparison",
            "experiments.synthetic.aggregate_loss_weighting_ablation",
            "experiments.synthetic.diagnose_descent_margin",
            "experiments.synthetic.run_inductive_bias_comparison",
